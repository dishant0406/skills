...
1. Open managed Chrome and go to `x.com`.
2. Wait for the home feed or profile to finish loading.
3. Read a small amount of context first:
   - Scroll through a few recent posts
   - Open a few relevant posts or threads one by one
   - Return to the main feed or profile
4. Open the composer.
5. Paste or type the final tweet.
6. Re-read once for clarity, links, and accidental repetition.
7. Publish.
8. Open the posted tweet and verify it rendered correctly.
9. Close all `x.com` tabs.
